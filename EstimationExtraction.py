...
for i in xrange(Entries):
    ...
    del(HiggsV); del(Higgs1stJV); del(Higgs2ndJV); del(J6thV); del(TprimeV); del(W1V); del(Top2); del(W2); del(TopJV)

DataEArray=np.array([DataE]); DataESampleFile="DataE_2"+InclusiveVersions[0][:-1]
